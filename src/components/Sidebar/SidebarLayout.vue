...
function selectMenu(id: string) { activeId.value = id }
</script>
    ...
    <SidebarProvider :defaultOpen="!isCollapsed">
        <div class="app-sidebar-layout">
            <Sidebar :collapsed-width="49" :width="236">
                ...
                <SidebarContent>
                    <SidebarMenu>
                        <MenuTreeNode :list="menuConfig" :collapsed="isCollapsed" :activeId="activeId"
                            @select="selectMenu" />
                    </SidebarMenu>
                </SidebarContent>
            ...
            <main class="main-content">
                <div class="main-header">
                    <SidebarTrigger asChild @click="toggleSidebar">
                        <Icon :name="isCollapsed ? 'panel-right' : 'panel-left'" :size="20" />
                    </SidebarTrigger>
