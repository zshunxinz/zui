<template>
    <div class="x-form-item" :class="[{
        ...
        <div v-if="label" class="x-form-item__label" :style="{
            width: labelWidthD.value,
            textAlign: labelAlign.value
        }">{{ label }}
        </div>
        <div class="x-form-item__content" :class="{
...
const labelAlign = computed(() => props.labelAlign || formContext?.labelAlign || 'right');
